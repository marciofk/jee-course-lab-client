...
export class DataService {
    ...
    customersBaseUrl = this.localApiServer + '/api/customers';
    ordersBaseUrl = this.localApiServer + '/api/orders';
    orders: IOrder[];
    states: IState[];
    ...
    getStates(): Observable<IState[]> {
        return this.http.get<IState[]>(this.localApiServer + '/api/states')
            .pipe(catchError(this.handleError));
    }
